...
import com.nesib.yourbooknotes.databinding.QuoteImageStyleItemBinding

class ColorBoxAdapter(val photoStyleColors:List<String>) : RecyclerView.Adapter<ColorBoxAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ColorBoxAdapter.ViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.quote_image_style_item, parent, false)
